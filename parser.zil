...
<ROUTINE CANT-ORPHAN ()
	 <COND (<AND <EQUAL? ,WINNER ,GUARDS>
		     <EQUAL? ,HERE ,DAIS>>
		<TELL "\"We">)
	       (T
		<TELL "\"I">)>
	 <TELL " don't understand! What are you referring to?\"" CR>
	 <RFALSE>>

...
<ROUTINE NAME? (WRD)
	 <COND (<OR <EQUAL? .WRD ,W?FORD ,W?ZAPHOD ,W?BEEBLE>
		    <EQUAL? .WRD ,W?TRILLI ,W?TRICIA ,W?MCMILL>
		    <EQUAL? .WRD ,W?PROSSE ,W?MARVIN ,W?ARTHUR>
		    <EQUAL? .WRD ,W?DENT ,W?PREFEC ,W?PHIL>
		    <EQUAL? .WRD ,W?EDDIE ,W?MARV ,W?ED>>
		<RTRUE>)
	       (T
		<RFALSE>)>>
		 ...
		 (T
		  ...
		  <COND (<EQUAL? .WRD ,W?ALL ,W?BOTH>
			...
			(<AND <SET WV <WT? .WRD ,PS?ADJECTIVE ,P1?ADJECTIVE>>
			      <ADJ-CHECK .WRD>
			      ;"for LOOK AT CUP OF TEA"
			      <OR <NOT <EQUAL? .WRD ,W?TEA>>
				  <NOT <EQUAL? ,P-NAM ,W?CUP>>>>
			 <SETG P-ADJ .WV>
			 <SETG P-ADJN .WRD>)
			    ...
			    (T
			     ...
			     <COND (<AND <G? .LEN 1>
					 ...
					 <OR <AND <EQUAL? ,P-NAM
							  ,W?FLUFF ,W?DRIVE>
						  <NOT ,P-ADJ>>
					     <AND <EQUAL? ,P-NAM ,W?TOOLS
							  	 ,W?TOOL>
						  <EQUAL? ,P-ADJN ,W?PROPER>>
					     <AND <EQUAL? ,P-NAM ,W?DRIVE>
						  <EQUAL? ,P-ADJN ,W?IMPROB>>>>
				    <SET GEN <GETP <GET .TBL .LEN> ,P?GENERIC>>
				   <PUT .TBL ,P-MATCHLEN <SET LEN <+ .TLEN 1>>>
				    <PUT .TBL .LEN .GEN>
				    <SETG P-XNAM ,P-NAM>
				    <SETG P-XADJ ,P-ADJ>
				    <SETG P-XADJN ,P-ADJN>
		   ...
		   <COND (<==? .OBJ ,IT>
			  <COND (<NOT <ACCESSIBLE? ,P-IT-OBJECT>>
				...
				(T
				 <SET OBJ ,P-IT-OBJECT>)>)>
		   <COND (<OR <HELD? .OBJ>
			      <EQUAL? .OBJ ,HANDS ,SLEEVES ,SPEECH>
			      <AND <EQUAL? .OBJ ,NO-TEA>
				   ,HOLDING-NO-TEA>
			      <AND <EQUAL? .OBJ ,GUARANTEE>
				   <VERB? SHOW>>>
			  T)
			 (T
			  <SETG PRSO .OBJ>
